...
const LogInIcon = ({ color, height, width }) => {
  return (
    <svg
      fill={color}
      width={width}
    ...
    >
      <g>
        <g>
          <path
            d="M437.333,0H202.667c-29.397,0-53.333,23.936-53.333,53.333v128c0,5.888,4.779,10.667,10.667,10.667
      ...
      <g>
        <g>
          <path
            d="M352,234.667H10.667C4.779,234.667,0,239.445,0,245.333S4.779,256,10.667,256H352c5.888,0,10.667-4.779,10.667-10.667
      ...
      <g>
        <g>
          <path
            d="M359.531,237.824l-64-64c-4.16-4.16-10.923-4.16-15.083,0s-4.16,10.923,0,15.083l56.448,56.448l-56.448,56.448
